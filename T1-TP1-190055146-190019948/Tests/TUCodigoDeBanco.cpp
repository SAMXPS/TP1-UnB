#include "TUCodigoDeBanco.h"
using namespace std;

bool TUCodigoDeBanco::configurar() {
    try {
        this->instancia = new CodigoDeBanco(this->getValorDefault());
...
void TUCodigoDeBanco::terminar() {
    delete instancia;
}

bool TUCodigoDeBanco::testarCenarioSucesso() {
    try {
...
bool TUCodigoDeBanco::testarCenarioFalha() {
...
ResultadoTU TUCodigoDeBanco::testar() {
