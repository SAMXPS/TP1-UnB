...
bool TUClasse::configurar() {
    try {
        this->instancia = new Classe(this->getValorDefault());
...
void TUClasse::terminar() {
    delete instancia;
}

bool TUClasse::testarCenarioSucesso() {
    try {
...
bool TUClasse::testarCenarioFalha() {
