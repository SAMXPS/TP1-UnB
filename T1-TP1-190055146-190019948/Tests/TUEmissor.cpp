...
bool TUEmissor::configurar() {
    try {
        this->instancia = new Emissor(this->getValorDefault());
...
void TUEmissor::terminar() {
    delete instancia;
}

bool TUEmissor::testarCenarioSucesso() {
    try {
...
bool TUEmissor::testarCenarioFalha() {
