#include "TUEndereco.h"
using namespace std;

bool TUEndereco::configurar() {
    try {
        this->instancia = new Endereco(this->getValorDefault());
...
void TUEndereco::terminar() {
    delete instancia;
}

bool TUEndereco::testarCenarioSucesso() {
    try {
...
bool TUEndereco::testarCenarioFalha() {
