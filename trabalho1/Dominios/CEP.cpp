 ...
 */
void CEP::validate(long valor) throw(std::invalid_argument) {
    ...
    ) throw new std::invalid_argument("O valor de CEP informado não está dentro das faixas válidas definidas.");
}
