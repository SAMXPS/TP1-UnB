...
bool TUSenha::configurar() {
    try {
        this->instancia = new Senha(this->getValorDefault());
...
void TUSenha::terminar() {
    delete instancia;
}

bool TUSenha::testarCenarioSucesso() {
    try {
...
bool TUSenha::testarCenarioFalha() {
