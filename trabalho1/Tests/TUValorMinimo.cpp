#include "TUValorMinimo.h"
using namespace std;

bool TUValorMinimo::configurar() {
    try {
        this->instancia = new ValorMinimo(this->getValorDefault());
...
void TUValorMinimo::terminar() {
    delete instancia;
}

bool TUValorMinimo::testarCenarioSucesso() {
    try {
...
bool TUValorMinimo::testarCenarioFalha() {
...
ResultadoTU TUValorMinimo::testar() {
