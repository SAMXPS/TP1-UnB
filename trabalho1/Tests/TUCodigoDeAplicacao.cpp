#include "TUCodigoDeAplicacao.h"
using namespace std;

bool TUCodigoDeAplicacao::configurar() {
    try {
        this->instancia = new CodigoDeAplicacao(this->getValorDefault());
...
void TUCodigoDeAplicacao::terminar() {
    delete instancia;
}

bool TUCodigoDeAplicacao::testarCenarioSucesso() {
    try {
...
bool TUCodigoDeAplicacao::testarCenarioFalha() {
...
ResultadoTU TUCodigoDeAplicacao::testar() {
