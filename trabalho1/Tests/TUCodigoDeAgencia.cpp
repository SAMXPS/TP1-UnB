#include "TUCodigoDeAgencia.h"
using namespace std;

bool TUCodigoDeAgencia::configurar() {
    try {
        this->instancia = new CodigoDeAgencia(this->getValorDefault());
...
void TUCodigoDeAgencia::terminar() {
    delete instancia;
}

bool TUCodigoDeAgencia::testarCenarioSucesso() {
    try {
...
bool TUCodigoDeAgencia::testarCenarioFalha() {
...
ResultadoTU TUCodigoDeAgencia::testar() {
